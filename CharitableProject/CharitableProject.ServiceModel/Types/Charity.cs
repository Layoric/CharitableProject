...
namespace CharitableProject.ServiceModel.Types
{
    public class Charity
    {
        ...
        public string Promote_or_oppose_a_change_to_law_government_poll_or_prac { get; set; }
        ...
        public string Promoting_reconciliation_mutual_respect_and_tolerance { get; set; }
